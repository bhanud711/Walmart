...
public void cart() throws InterruptedException
{
	...
	loginButton.click();
	Thread.sleep(10000);
	WebElement cart = driver.findElement(By.xpath("//a[@id='hf-cart']"));
	cart.click();
	WebElement qty = driver.findElement(By.xpath("//select[@aria-label='Quantity']"));
	Select s=new Select(qty);
	s.selectByValue("2");
	System.out.println("The quantity of the item value is changing");
	s.selectByValue("1");
