...
public class StoreFindTest {
	...
	public void store() throws InterruptedException
	{
		...
		WebElement localstore = driver.findElement(By.xpath("//div[text()='Track Orders']"));
 	    WebElement findstore = driver.findElement(By.xpath("//div[text()='Store Finder']"));
 	    a.moveToElement(localstore).moveToElement(findstore).click().build().perform();
	}
}
